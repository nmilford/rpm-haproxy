...
%build
%{__make} USE_PCRE=1 DEBUG="" ARCH=%{_target_cpu} TARGET=linux26 USE_OPENSSL=1 SSL_INC=%{buildroot}/dist/install/include SSL_LIB=%{buildroot}/dist/install/lib ADDLIB=-ldl CFLAGS="-O2 -g -fno-strict-aliasing"
